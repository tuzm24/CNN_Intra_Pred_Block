...
parser.add_argument('--data_train', type=str, default='intra_mode_pred_qp',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='intra_mode_pred_qp',
...
parser.add_argument('--data_type', type=str, default=PictureFormat.INDEX_DIC[PictureFormat.ORIGINAL],
                    help='get data type')
...
parser.add_argument('--model', default='rdn_intramode',
                    help='model name')
